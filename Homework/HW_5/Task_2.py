...
Players = ['Player_1', 'Player_2', 'Alise_Bot']
    ...
    if (Player == 'Alise_Bot'):
        ...
        while (x not in range(1, 29)):
            try:
                ...
                continue
            print('Неправильный ход, повторите ввод: ')
...
def StartGame():
    print('Добро пожаловать в игру c конфетами!\n')
    ...
    print(
        f'Сегодня у нас играют {Players[0]} и {Players[1]}! И первым делает ход:')
